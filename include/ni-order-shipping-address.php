...
if( !class_exists( 'ni_order_list' ) ) {
	class ni_order_shipping_address extends ni_function{
           ...
           <div class="wooreport_content">
              <div class="wooreport_search_form">
                 <form method="post" name="ni_frm_order_export" id="ni_frm_order_export">
                    <div class="wooreport_search_title">Shipping Address</div>
                    ...
                    <input type="<?php echo $input_type; ?>" name="ni_action_ajax" value="ni_order_shipping_address" />
                    <input type="<?php echo $input_type; ?>" name="page" value="<?php echo isset($_REQUEST["page"])?$_REQUEST["page"]:""; ?>" />
                 </form>
              </div>
		...
		function get_order_grid()
		{
			...
			if(count($order_data)> 0)
			{
                ...
                <form id="ni_frm_order_export" action="" method="post">
                    <input type="submit" value="Excel" name="btn_excel_export_shipping" class="ni_btn wooreport_button" id="btn_excel_export" />
				...
				?>
					<tr>
                        ...
                        <td> <?php echo isset($v->shipping_first_name)?$v->shipping_first_name:"";?> </td>
						<td> <?php echo isset($v->shipping_last_name)?$v->shipping_last_name:"";?> </td>
                        <td> <?php echo isset($v->shipping_company)?$v->shipping_company:"";?> </td>
                        <td> <?php echo isset($v->shipping_address_1)?$v->shipping_address_1:"";?> </td>
                        <td> <?php echo isset($v->shipping_address_2)?$v->shipping_address_2:"";?> </td>
                        <td> <?php echo isset($v->shipping_city)?$v->shipping_city:"";?> </td>
                        <td> <?php echo isset($v->shipping_postcode)?$v->shipping_postcode:"";?> </td>
                        <td> <?php echo $this->get_country_name(isset($v->shipping_country)?$v->shipping_country:"");?> </td>
                        <td> <?php echo isset($v->shipping_state)?$v->shipping_state:0;?> </td>
                        <td> <?php echo isset($v->shipping_phone)?$v->shipping_phone:0;?> </td>
					</tr>	
				<?php }?>
				</table>
					...
					foreach($columns as $key => $value):
						switch ($key) {
							...
							case "shipping_country":	
								$export_rows[$i][$key] = $this->get_country_name(isset($rvalue->shipping_country)?$rvalue->shipping_country:"");
								break;	
							default:
