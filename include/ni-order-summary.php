	...
	class ni_order_summary extends ni_function{
		...
		<div class="parent_content">
			<div class="content">
				...
				<h1 style="text-align:center; color:#685e21">Buy Ni WooCommerce Sales Report Pro @ $24.00</h1>
				<div style="width:33%; float:left; padding:5px">
					<ul>
                        ...
                        <li style="font-weight:bold; color:#685e21">Sold Product variation Report</li>
				...
				<div style="width:33%;padding:5px; float:left">
					<ul>
                        ...
                        <li style="font-weight:bold; color:#685e21">Stock Report(Simple, Variable and Variation Product)</li>
					</ul>
				</div>
				<div>
					<ul>
				...
				<div style="border-bottom:4px solid #685e21;"></div>
				<div class="box-data">
					<div class="columns-box" style="border-top:4px solid #BA68C8">
						<div class="columns-title"><?php _e('Total Sales', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box"  style="border-top:4px solid #EF6C00">
						<div class="columns-title"><?php _e('This Year Sales', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #00897B">
						<div class="columns-title"><?php _e('This Month Sales', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box"  style="border-top:4px solid #039BE5">
						<div class="columns-title"><?php _e('This Week Sales', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box"  style="border-top:4px solid #795548">
						<div class="columns-title"><?php _e('Yesterday Sales', 'NiWooCommerceSalesReport'); ?></div>
						<div>
                ...
                <div class="box-data">
					<div class="columns-box"  style="border-top:4px solid #BA68C8">
						<div class="columns-title"><?php _e('Total Sales Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #EF6C00">
						<div class="columns-title"><?php _e('This Year Sales Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #00897B">
						<div class="columns-title"><?php _e('This Month Sales Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #039BE5">
						<div class="columns-title"><?php _e('This Week Sales Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box"  style="border-top:4px solid #795548">
						<div class="columns-title"><?php _e('Yesterday Sales Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
				...
				<div class="box-title"><i class="fa fa-pie-chart" aria-hidden="true"></i> <?php _e('Customer Analysis ', 'NiWooCommerceSalesReport'); ?> </div>
				<div style="border-bottom:4px solid #685e21;"></div>
                <div class="box-data">
					<div class="columns-box" style="border-top:4px solid #BA68C8">
						<div class="columns-title"><?php _e('Total Customer Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #EF6C00">
						<div class="columns-title"><?php _e('Today Customer Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #00897B">
						<div class="columns-title"><?php _e('Total Guest Customer Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
					...
					<div class="columns-box" style="border-top:4px solid #039BE5">
						<div class="columns-title"><?php _e('Today Guest Customer Count', 'NiWooCommerceSalesReport'); ?></div>
						<div>
			...
			<div class="content">
				...
				<div style="border-bottom:1px solid #685e21;"></div>
				<div class="box-data">
					<table class="data-table">
                       ...
                       <tr>
                            ...
                            <td><?php echo isset($v->billing_country)?$v->billing_country:""; ?></td>
